...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FInteractionComponentDelegate, UActorComponent*, Component);
...
protected:
	...
	UPROPERTY(BlueprintAssignable)
	FInteractionComponentDelegate OnInteractionComponentFocusChange;
private:
